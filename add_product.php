<?php
  $page_title = 'Agregar producto - Ecomponenti';
...
<?php
 if(isset($_POST['add_product'])){
   ...
   if(empty($errors)){
     ...
     $p_prov   = remove_junk($db->escape($_POST['product-provider']));
     ...
     $query .=" name,quantity,buy_price,sale_price,categorie_id,provider_id,media_id,date";
     $query .=") VALUES (";
     $query .=" '{$p_name}', '{$p_qty}', '{$p_buy}', '{$p_sale}', '{$p_cat}', '{$p_prov}', '{$media_id}', '{$date}'";
     $query .=")";
